...
def inspireme():
    ...
    responses = [
        ...
        # Humour
        "If you’re stuck for ideas, consider a werechair (a chair bitten by a werewolf).",
        "What would Sephiroth write?",
        "Whatever you have planned, don’t worry about it. I’m sure Cloud won’t mind...",
